...
const JobsPosted = () => {
  ...
  useEffect(() => {
    ...
    const fetchJobs = async () => {
      try {
        const res = await API.get('/jobs'); // backend filters by current_user_id if JWT present
  ...
  return (
    <div className="mt-24 max-w-6xl mx-auto p-4">
      <h1 className="text-3xl font-mono text-green-700 mb-6 text-center">Jobs Posted</h1>
